            ...
            {people.map((person) => (
              <li key={person.name}>
                ...
                <ul role="list" className="mt-6 flex gap-x-6">
                  <li>
                    <a href={person.twitterUrl} className="text-orange-900 hover:text-orange-900">
                  ...
                  <li>
                    <a href={person.linkedinUrl} className="text-orange-900 hover:text-orange-900">
