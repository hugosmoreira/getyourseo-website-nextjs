  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <h2 className="text-base font-semibold leading-7 text-orange-900">Pricing</h2>
            ...
            {tiers.map((tier) => (
                ...
                <a
                    ...
                    className={classNames(
                    tier.mostPopular
                        ? 'bg-orange-900 text-white hover:bg-orange-500'
                    ...
                    <li key={section.name}>
                        ...
                        {section.features.map((feature) =>
                            ...
                            <li key={feature.name} className="flex gap-x-3">
                                <CheckIcon className="h-6 w-5 flex-none text-orange-900" aria-hidden="true" />
                                <span>
                                {feature.name}{' '}
                ...
                <tbody>
                    ...
                    {tiers.map((tier) => (
                        ...
                        <a
                            ...
                            tier.mostPopular
                                ? 'bg-orange-900 text-white hover:bg-orange-500'
                                : 'text-orange-900 ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300',
                            'mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'
                            )}
                        >
                            Buy plan
                        ...
                        <tr key={feature.name}>
                            ...
                            <td key={tier.id} className="px-6 py-4 xl:px-8">
                                ...
                                <>
                                    ...
                                    <CheckIcon className="mx-auto h-5 w-5 text-orange-900" aria-hidden="true" />
                                    ) : (
